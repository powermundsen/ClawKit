...
from clawkit.router.agents import provider_environment
...
def provider_executable(paths: ClawKitPaths, provider: str) -> Path:
    if provider == "claude":
...
def _auth_command(paths: ClawKitPaths, provider: str, action: str) -> list[str]:
