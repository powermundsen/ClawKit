"""Strict loading of Mundsen runtime and secret settings."""
...
def load_runtime_settings(
    ...
    *,
    ...
    explicitly required, or use the ``MUNDSEN_`` namespace.
    """
    ...
    imported_names.update(name for name in env if name.startswith("MUNDSEN_"))
